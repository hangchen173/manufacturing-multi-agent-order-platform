...
from app import app
from domain.models import OrderItem, MatchedOrder, MatchedOrderItem, OrderStatus, ParsedOrder, RiskCheckResult
...
class TestOrderAPI(unittest.TestCase):
    ...
    @patch('application.orchestrators.order_processing.OrderProcessingOrchestrator.process_order_from_text')
    ...
    @patch('application.orchestrators.order_processing.OrderProcessingOrchestrator.get_order_status')
    ...
    @patch('application.orchestrators.order_processing.OrderProcessingOrchestrator.confirm_order')
    ...
    def test_order_not_found(self):
        ...
        with patch('application.orchestrators.order_processing.OrderProcessingOrchestrator.get_order_status') as mock_get:
